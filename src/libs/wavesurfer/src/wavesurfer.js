...
export default class WaveSurfer extends util.Observer {
    ...
    getWindowOffset() {
        ...
        return this.getDuration() * start / width;
    }
    ...
    getWindowLength() {
        ...
        return this.getDuration() * (end - start) / width;
    }
    ...
    zoomFit(start, end) {
        const pxPerSec = Math.min(Math.round(
            this.drawer.getWidth() / this.params.pixelRatio / (end - start)
        ),200);
        // pxPerSec = Math.min(pxPerSec,200)
        ...
        this.drawer.recenter(center / this.getDuration());
    }
